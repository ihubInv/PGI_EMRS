...
CREATE TABLE IF NOT EXISTS outpatient_record (
    ...
    head_age INT,
    head_relationship VARCHAR(50),
    head_education VARCHAR(50),
    head_occupation VARCHAR(100),
    head_income NUMERIC(12,2),
    distance_from_hospital VARCHAR(100),
...
CREATE TABLE IF NOT EXISTS clinical_proforma (
    ...
    nature_of_information VARCHAR(50),
    onset_duration VARCHAR(50),
    course VARCHAR(50),
...
CREATE TABLE IF NOT EXISTS adl_files (
    ...
    physical_file_location VARCHAR(100),
